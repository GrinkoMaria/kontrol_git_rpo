...
https://github.com/GrinkoMaria/kontrol_git_rpo      - ссылка на гит хаб
...
- Папки `venv/` и `.venv/` не добавляют в Git, их можно создать заново.
- Перед коммитом нужно проверять Source Control.

Клонировала шаблон проекта из GitHub.
...
8. Внесла изменения в ветке и сделала коммит.
